        ...
        <div className='main-content'>
          ...
          <form onSubmit={handleSubmit(handleCreateRoom)}>
            ...
            <Button type='submit' disabled={isSubmitting}>
              {isSubmitting ? (
                <svg aria-hidden="true" className="inline w-6 h-6 text-gray-200 animate-spin dark:text-purple-500 fill-purple-700" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
